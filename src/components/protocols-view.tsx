...
export function ProtocolsView({ initialProtocols }: { initialProtocols: Protocol[] }) {
  ...
  return <div className="mx-auto max-w-4xl">
    <div className="mb-4 flex flex-wrap items-center justify-between gap-3"><div><p className="text-xs font-semibold uppercase tracking-[.2em] text-[var(--brand)]">Biblioteca del Drive de mgzlota</p><h1 className="text-2xl font-semibold">Protocolos</h1></div><button className="flex items-center gap-1.5 rounded-lg bg-[var(--brand)] px-3 py-2 text-xs font-semibold text-white" onClick={() => openForm()} type="button"><Plus size={15} /> Agregar enlace</button></div>
